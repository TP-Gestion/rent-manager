...
class BillingControllerTest extends BaseControllerTest {
    ...
    void test13_getBillingsByProperty_paidBillingIncludesPaymentDate() throws Exception {
        ...
        mockMvc.perform(multipart("/api/v1/properties/" + property.getId() + "/payments").param("amount", "150000").param("paymentMethod", "BANK_TRANSFER").param("paymentDate", "2026-04-01").param("selectedPeriods", "2026-03"));
