...
import ar.com.aeb.alquileres.exception.building.DuplicateBuildingException;
...
public class BuildingService {
    ...
    public BuildingResponse getById(Long id) {
        Building building = buildingRepository.findById(id).orElseThrow(() -> new BuildingNotFoundException(id));
